...
%  fff = plot(u_100_0_90_exp,f_100_0_90_exp,':k','LineWidth',3);hold on;
 ...
 legend([a,b,aa,bb,aaa,bbb,aaaa],'60-0-lin','60-0-exp','80-0-lin','80-0-exp','100-0-lin','100-0-exp','100-0-lin-Gm_2_._5');
 legend([e,f,ee,ff,eee,fff],'60-45-lin','60-45-exp','80-45-lin','80-45-exp','100-45-lin','100-45-exp');
 grid on
 xlabel('Œª“∆(mm)');
 ylabel('‘ÿ∫…(N)');
 axis([0 4 0 55000]);

...
% c = plot(u_60_45_lin(1:500,1),f_60_45_lin(1:500,1),'r','LineWidth',3);hold on;
 a = plot(u_60_0_lin(1:1100),f_60_0_lin(1:1100),'r','LineWidth',3);hold on;
 b = plot(u_60_0_exp(1:310),f_60_0_exp(1:310),':r','LineWidth',3);hold on;
...
%  f = plot(u_60_0_90_exp(1:120),f_60_0_90_exp(1:120),':b','LineWidth',3);hold on;
 ...
 aa = plot(u_80_0_lin(1:2400),f_80_0_lin(1:2400),'b','LineWidth',3);hold on;
 bb = plot(u_80_0_exp(1:260),f_80_0_exp(1:260),':b','LineWidth',3);hold on;
...
%  ee2 = plot(u_80_0_90_lin_new,f_80_0_90_lin_new,'--b','LineWidth',3);hold on;
 ...
 aaa = plot(u_100_0_lin(1:620),f_100_0_lin(1:620),'k','LineWidth',3);hold on;
 bbb = plot(u_100_0_exp(1:260),f_100_0_exp(1:260),':k','LineWidth',3);hold on;
